...
public class HasilLuasBalok extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hasil_luas_balok);

        hasil = (TextView)findViewById(R.id.HasilLPBalok);
        ...
        hasil.setText("Luas Permukaan Balok : " + rumus.getLuasPermukaanBalok());
